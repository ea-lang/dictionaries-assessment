...
def word_length_sorted(words):
    ...
    for length in word_lengths:
        lengths.append((length, sorted(list(word_lengths[length]))))
...
def translate_to_pirate_talk(phrase):
    ...
    for word in words:
        if word in english_to_pirate:
            translated += english_to_pirate[word] + ' '
        else:
            translated += word + ' '
...
def kids_game(names):
    ...
    while True:
        ...
        if last_letter in first_letters:
            ...
            results.append(first_letters[last_letter][0])
            
            if len(first_letters[last_letter]) > 1:
                first_letters[last_letter] = first_letters[last_letter][1:]
            else:
                del first_letters[last_letter]
        else:
            break
